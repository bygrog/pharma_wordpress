...
if ( ! function_exists( 'neoocular_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function neoocular_get_filter_items( $params ) {
		...
		return apply_filters( 'neoocular_filter_get_filter_items', $items, $params );
	}
}
